package org.demo.demo.configuration.observer;
...
public class InitializeData implements ServletContextListener {
    ...
    @Inject
    public InitializeData(MusicianService musicianService, InstrumentService instrumentService, SkillService skillService, RequestContextController requestContextController) {
    ...
    private void init() {
        ...
        List<Instrument> instrumentsTest = instrumentService.findAll();
        Instrument instrumentTest = instrumentService.find(UUID.fromString("7d9d2e0e-cf45-4078-bf84-edb16423a30e")).orElseThrow();
        instrument2.setName("PIANO");
        instrumentService.update(instrument2);
        Instrument instrumentTest2 = instrumentService.find(UUID.fromString("7d9d2e0e-cf45-4078-bf84-edb16423a30e")).orElseThrow();
        instrumentService.delete(UUID.fromString("7d9d2e0e-cf45-4078-bf84-edb16423a30e"));
        List<Instrument> instrumentsTest2 = instrumentService.findAll();

        List<Skill> skillsTest = skillService.findAll();
        Skill skillTest = skillService.find(UUID.fromString("9b3bec33-428d-4c7d-a659-50aa5892a05a")).orElseThrow();
        skill1.setFavouriteModelName("Gibson SG Standard");
        skillService.update(skill1);
        Skill skillTest2 = skillService.find(UUID.fromString("9b3bec33-428d-4c7d-a659-50aa5892a05a")).orElseThrow();
        skillService.delete(UUID.fromString("9b3bec33-428d-4c7d-a659-50aa5892a05a"));
        List<Skill> skillsTest2 = skillService.findAll();

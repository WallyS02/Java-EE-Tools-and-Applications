...
public class MusicianPersistenceRepository implements MusicianRepository {
    ...
    @Inject
    public MusicianPersistenceRepository(ServletContext servletContext) {
    ...
    public Optional<Musician> findByLogin(String login) {
        try {
            return Optional.of(em.createQuery("select m from Musician m where and m.login = :login", Musician.class)
    ...
    public Optional<Musician> findByEmail(String email) {
        try {
            return Optional.of(em.createQuery("select m from Musician m where and m.email = :email", Musician.class)
